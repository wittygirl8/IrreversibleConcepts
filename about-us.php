            ...
            <div class="main_wrapper">
                ...
                <div class="hdr_rgt">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a target="_blank" href="coming_soon.html">
                ...
                <div class="main-wrap1" >
                    ...
                    <ul class="nav bold_font">
                        ...
                        <li class="home_res_mob "><a href="#"><span class="brdrnav first">About Us</span></a>
                            ...
                            <ul class="about">
                                ...
                                <li><a href="Why.html" id="abtus2">Why Irreversible Concepts <b>!</b></a></li>



                                <li><a href="about-us.html" class="border-none" id="abtus">About Irreversible Concepts</a></li>



                              <li><a href="mission-vision.html" id="abtus2">Mission & Vision</a></li>
                        ...
                        <li class="test"><a href="IES.html"><span class="brdrnav">IES</span> </a></li>



                        <li><a href="GATE.html"><span class="brdrnav">GATE</span></a></li>



                        <li><a style="text-transform: none"href="PSUs.html"><span class="brdrnav">PSUs</span></a></li>

<li><a href="#"><span class="brdrnav">IIT-JEE</span></a>
					   <ul class="about">



                                <li><a href="IIT-prenurture.html" id="abtus2">Pre-Nurture(IX Class)<b></b></a></li><li><a href="IIT-nurture.html" id="abtus2">Nurture(X Class)<b></b></a></li>



                                <li><a href="IIT-enthuse.html" class="border-none" id="abtus">Enthuse(XII Class)</a></li>



                              <li><a href="IIT-achiever.html" id="abtus2">Achiever(XII Class)</a></li>

                            </ul>
					   
					   
					   </li>
					   <li><a href="#"><span class="brdrnav">Medical</span></a>
					   <ul class="about">



                                <li><a href="MED-prenurture.html" id="abtus2">Pre-Nurture(IX Class)<b></b></a></li><li><a href="MED-nurture.html" id="abtus2">Nurture(X Class)<b></b></a></li>



                                <li><a href="MED-enthuse.html" class="border-none" id="abtus">Enthuse(XI Class)</a></li>



                              <li><a href="MED-achiever.html" id="abtus2">Achiever(XII Class)</a></li>
                       ...
                       <li><a href="#"><span class="brdrnav">Admissions</span></a>
					   <ul class="about">



                                <li><a href="icp.html" id="abtus2">Intensive Classroom Program<b></b></a></li>



                                <li><a href="coming_soon.html" class="border-none" id="abtus">Online Test series</a></li>



                              <li><a href="interviewGuidancePSU.html" id="abtus2">Interview Guidance</a></li>
                        ...
                        <li><a href="coming_soon.html"><span class="brdrnav">Downloads</span></a></li>



                        <li><a href="#"><span class="brdrnav">Gallery</span></a>
                            ...
                            <ul class="archive">
                                ...
                                <li><a href="photogallery.html"  class="border-none">Photo Gallery</a></li>
                        ...
                        <li><a href="ContactUs.html"><span class="brdrnav">Contact Us</span></a></li>
						<li><a href="login.html"><span class="brdrnav">Login</span></a></li>
        ...
        <title>About Irreversible Concepts</title>
</section>
</div>
<section>
 <div class="inrpghdr_link">
  <div class="pageheaderimage">
   ...
   <div class="main_wrapper">
    <div class="hdrpagetitle light">ABOUT Irreversible Concepts</div>
   </div>
  </div>
  <div class="pagelocation">
   <div class="main_wrapper">
    <ul>
     ...
     <li><a href="about-us.html" class="last">About Irreversible Concepts</a></li>
    </ul>
 ...
 <div class="main_wrapper">
  <div class="lnk_ansaddwpr">
    ...
    <h1 class="inr_title"><i class="sprite qklink"></i>Quick Links</h1>
    <div class="linkgate"> 
        <div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="Why.html">WHY Irreversible Concepts !</a>
                            </h1>

                </div>
				<div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="about-us.html">About Irreversible Concepts !</a>
                            </h1>

                </div>
				<div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="mission-vision.html">Mission & Vision !</a>
                            </h1>

                </div>
				<div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="icp.html">Incentive Classroom Program !</a>
                            </h1>

                </div>
				<div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="PSU.html">PSUs</a>
                            </h1>

                </div>
				<div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="GATE.html">GATE</a>
                            </h1>

                </div><div class="accordion1">
                                                    <h1 id="qkl" class="abtacordian"><a href="IES.html">IES</a>
                            </h1>
  ...
  <div class="aboutus1">
      <div id="aboutus">
        <h2>About Irreversible Concepts</h2>

<p>&nbsp;</p>

<p><strong>The Institute has established itself as a high quality education provider with prime focus on holistic learning and imbibing competitive abilities in students. Irreversible Concepts is for the commitment of quality in education as to bring out the best among best. Irreversible Concepts institute promises to become one of the India's leading Institute with an acknowledged reputation for excellence in research and teaching and Teaching Methodology. With its outstanding faculty from IITs, top class teaching standards, and innovative academic performance,ograms,Irreversible Concepts intends to set a new benchmark in the education system.</p>

<p>As an academy it will be our constant effort to provide the GATE , IES, PSUs aspirants with best online study materials in building their concepts. Through a colloquial market survey we realize that their lies immense potential in so many students which is not getting utilized due to lack of proper guidance and non-availability of well documented study materials. With the vision to channelize that potential IRREVERSIBLE CONCEPTS came into existence. This academy assures you to provide the best facilities and homely environment so that you yourself can explore the best out of you.</p>
...
var host = (document.location.protocol === 'about-us.html') ? 'http://cdn' : 'https://server';
